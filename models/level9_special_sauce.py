"""
Level 9: Special Sauce
=======================
Level 8 replicated the 1st place solution. Level 9 adds three differentiators:

1. BETTER ELO: Our Level 4 Elo (K=32, margin-of-victory weighting, 60% carry-over)
   replaces the basic Elo (K=100, no margin, full season reset). Margin-weighted Elo
   proved significantly better in our earlier testing.

2. MASSEY ORDINALS: KenPom (POM) and average Massey rank as features. These encode
   the consensus of ~60 independent ranking systems — information the 1st place
   solution completely ignored.

3. LATE-SEASON WEIGHTING: Separate feature set computed from only the last 14 days
   of the regular season (DayNum 119-132). A team's February/March form is far more
   predictive of tournament performance than November form. We include BOTH full-season
   and late-season versions, letting XGBoost decide when each matters.
"""
...
output_path = "submission_level9_special_sauce.csv"
